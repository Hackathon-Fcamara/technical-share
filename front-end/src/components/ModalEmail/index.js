...
const { modalEmail__overlay, modalEmail__container, modalEmail__content } =
  styles;
  ...
  return (
    ...
    >
      <div className={modalEmail__content}>
        <figure>
          <img src="https://picsum.photos/192/192" alt="Foto do perfil" />
        </figure>
        <h1>E-mail enviado!</h1>
        <h2>Foi enviada uma mensagem para o mentor.</h2>
        <p>
          Em breve você terá um retorno por e-mail sobre a confirmação do
          agendamento.
        </p>
      </div>
    </Modal>
